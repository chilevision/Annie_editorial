...
{
    public $rundowns    = 5;      //Set this to the amount of rundowns you want to create.
    public $max_users   = 5;       //Set this to the max amount of users for each rundown.
    public $add_rows    = false;    //Set this to true if you want to generate rows to each rundown.
    public $rows        = 10;      //Set this to the amount of rows you want for each rundown.
    public $add_meta    = false;    //Set this to true if you want to generate meta rows to each rundown row.
