...
class unlock extends Command
{
     ...
     * @var string
     */
    protected $description = 'Unlocks all locked rows and meta rows if older than 5 minutes.';
    ...
    {
        if (Schema::hasTable('rundown_rows')) {
        ...
        if (Schema::hasTable('rundown_meta_rows')) {
