<div class="modal-dialog modal-xl">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="casparModalLabel">{{ __($title) }}</h5>
...
@endif
        ...
        <button type="button" class="btn btn-custom" data-dismiss="modal" onclick="selectFile();">{{ __('rundown.select') }}</button>
      </div>
  </div>
</div>