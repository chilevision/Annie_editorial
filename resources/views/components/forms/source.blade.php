<div class="form-group {{ $wrapClass }}">
    ...
    <div class="input-group">
        <input type="{{ $type }}" value="{{ $value }}" name="{{ $name }}" wire:model="{{ $wires }}" class="form-control shadow-none {{ $inputClass }}" id="input-{{ $name }}" placeholder="mediefil" aria-describedby="source-search"/>
